...
/**
* implementation for MCI service proxy
*
...
public class MCIServiceImpl implements MCIService {
    ...
    public MCIServiceImpl(String url) {
        this.url = url;
    }
    ...
    */
    ...
    public MCIGetTokenResponse getToken() {
        ...
        // process response
        MCIGetTokenResponse getTokenResponse = parseResponse(response, "GetTokenResponse", MCIGetTokenResponse.class);
    ...
    public MCIRechargeResponse recharge(String token, String username, String password,
        ...
        // process response
        MCIRechargeResponse rechargeResponse = parseResponse(response, "RechargeReponse", MCIRechargeResponse.class);
