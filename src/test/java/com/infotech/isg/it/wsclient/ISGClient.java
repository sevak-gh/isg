...
public class ISGClient {
    ...
    public ISGServiceResponse rightel(String username, String password,
                                      ...
                                      String consumer, String customerIp) {
        // create empty soap request
        SOAPMessage request = SOAPHelper.createSOAPRequest(namespace, namespace + "/Rightel");

        // add request body/header
        try {
            SOAPBody body = request.getSOAPBody();
            SOAPBodyElement bodyElement = body.addBodyElement(new QName(namespace, "Rightel", SOAPHelper.NAMESPACE_PREFIX));
            SOAPElement element = bodyElement.addChildElement(new QName("username"));
            element.addTextNode(username);
            element = bodyElement.addChildElement(new QName("password"));
            element.addTextNode(password);
        ...
        // process response
        ISGServiceResponse isgServiceResponse = SOAPHelper.parseResponse(response, namespace, "RightelResponse", ISGServiceResponse.class);

        return isgServiceResponse;
    }

    public ISGServiceResponse vopay(String username, String password,
                                      String action,
                                      String bankCode, int amount,
                                      int channel, String state,
                                      String bankReceipt, String orderId,
                                      String consumer, String customerIp) {
        // create empty soap request
        SOAPMessage request = SOAPHelper.createSOAPRequest(namespace, namespace + "/Vopay");

        // add request body/header
        try {
            SOAPBody body = request.getSOAPBody();
            SOAPBodyElement bodyElement = body.addBodyElement(new QName(namespace, "Vopay", SOAPHelper.NAMESPACE_PREFIX));
            SOAPElement element = bodyElement.addChildElement(new QName("username"));
            element.addTextNode(username);
            element = bodyElement.addChildElement(new QName("password"));
            element.addTextNode(password);
        ...
        // process response
        ISGServiceResponse isgServiceResponse = SOAPHelper.parseResponse(response, namespace, "VopayResponse", ISGServiceResponse.class);
